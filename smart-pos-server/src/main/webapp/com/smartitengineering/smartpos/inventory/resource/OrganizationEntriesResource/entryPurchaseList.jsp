<%-- 
    Document   : entryPurchaseList
    Created on : Sep 27, 2010, 11:24:31 AM
    Author     : russel
--%>
...
<div class="show" id="showList">
  ...
  <div id="top_row" class="list_column_names">
    ...
    <div class="tableheadname_user">
      <label class="tablehead_label"><fmt:message key="inv.prdentryinput2"/></label>s
    </div>
  </div>
...
<div class="hide" id="create">
  ...
  <div id="form_EntriesEntry" class="entry_form_pos">
    <form action="http://russel:9090/orgs/sn/${orgInitial}/inv/entries/purchase" accept="application/json" enctype="" id="entryList" method="post">

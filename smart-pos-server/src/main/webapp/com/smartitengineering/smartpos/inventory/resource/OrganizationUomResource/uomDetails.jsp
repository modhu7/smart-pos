...
<div id="showList" class="show">
  ...
  <div id="individual_user_details_content" class="content_details_info">
    ...
    <form method="POST" action ="http://localhost:10090/orgs/sn/${orgInitial}/inv/uoms/name/${it.id.id}/delete" accept="application/json" id="organizationform">
      <input type="hidden" name="uomId" value="${it.id}" class="textField" id="id">
      <div class="clear"></div>
...
<div id="create" class="hide">
  <div id="header_organization_uom" class="header_entry_form"><label id="header_uom_label"><c:out value="${it.id}"></c:out><fmt:message key="inv.uomedittablehead1" /></label></div>

  <fmt:message key="inv.uomeditbtn" var="submitbtn"/>
  <div class="toRoundBox">
    <div id="form_organizationentry" class="entry_form">
      <form method="POST" action ="http://localhost:10090/orgs/sn/${orgInitial}/inv/uoms/name/${it.id.id}/update" accept="application/json" id="userEditForm">
        <input type="hidden" name="uomId" value="${it.organizationId}" class="textField" id="id">
        ...
        <div style="clear: both"></div>
        <div class="form_label"><label><fmt:message key="inv.uominput2"/></label></div>
        <div class="form_textField"><input type="text" name="id" class="textField" id="id" value="${it.id.id}"></div>
        <div style="clear: both"></div>
